...
// let newListing = listing.filter(todo => {
// return todo.userId == 9
// });

// console.log(newListing);

// let incomplete = listing.filter(notComplete => {

//   return notComplete.userId === 9 && notComplete.completed === false
...
let newObject = listing.filter(user => {
  return ([3, 7, 8]).includes(user.userId)
